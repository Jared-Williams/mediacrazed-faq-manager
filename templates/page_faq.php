<?php
/**
 * This file adds the FAQ page template from the MediaCrazed FAQ Manager Plugin.
 *
 * @author MediaCrazed
...
add_filter( 'body_class', 'faq_add_body_class' );
function faq_add_body_class( $classes ) {
